...
import * as Subheader from "@material-ui/core/ListSubheader";
    ...
    <GridList cellHeight={180} cols={3}>
      ...
      {users.map((user) => (
        <GridListTile key={user.login}>
          <img
            src={user.profile_image_url || "assets/GlitchIcon_purple.png"}
            alt={user.login}
          />
          <GridListTileBar
      ...
      >
        ...
        >
          <div className={classes.modal}>
            <UserDetails
              user={detailsPopUp.user}
              actionHandler={this.closeUserOptionsMenu.bind(this)}
            />
          </div>
        </Modal>
        ...
        <Grid
          container
          spacing={0}
          className={[classes.chatBody, classes.spacingBlock].join(" ")}
        >
