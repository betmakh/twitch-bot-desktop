...
export const AUTH_URL = `https://api.twitch.tv/kraken/oauth2/authorize?client_id=${TOKEN}&redirect_uri=https://localhost&response_type=token+id_token&scope=chat_login+viewing_activity_read+openid`;
