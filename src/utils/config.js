module.exports = {
	PASS: 'oauth:ngqsibig939or6zhc2ak6lt1p3h8y5', //bot access token (individual for each user)
	CHANNELS: ['friendly_devil', 'letofski'], //channels to join
	USER: 'betmanenkobot', //bot nickname
	...
	messages: {
		...
		jockeAboutLysyi: ['... Лысый, хто тут нарыгал?\n А я вступил - новые носки. Бля заебал!']
	},
